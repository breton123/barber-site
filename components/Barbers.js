    ...
    return (
        <div className="bg-gray-800 pt-20 pb-20 flex flex-col items-center shadow-xl">
            ...
            <div className="grid lg:grid-cols-3 pt-10">
                <div className="flex flex-col items-center transition duration-300 ease-out cursor-pointer group mr-10 hover:scale-105">
                ...
                <div className="flex flex-col items-center transition duration-300 ease-out cursor-pointer group ml-10 hover:scale-105">
