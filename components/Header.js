...
function Header() {
    ...
    return (
        <div className="flex justify-between top-0 fixed w-screen py-5 px-5 items-center">
            <div onClick={() => {changeSidebar()}} className="flex justify-start items-center cursor-pointer group">
                {!open &&
                    <MenuIcon className='text-yellow-600 px-8 py-3 h-12 md:p-3 md:h-14 p-3 h-14 bg-[#1a1d21] group-hover:bg-[#bf9456] group-hover:text-[#1a1d21] translate-x-1 transition duration-200 ease-out' />
                }
                {open &&
                    <MinusIcon className='text-yellow-600 px-8 py-3 h-12 md:p-3 md:h-14 p-3 h-14 bg-[#1a1d21] group-hover:bg-[#bf9456] group-hover:text-[#1a1d21] translate-x-1 transition duration-200 ease-out' />
                }
